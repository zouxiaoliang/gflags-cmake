#ifndef EXTEND_FLAGS_H
#define EXTEND_FLAGS_H
...
public:
     ...
     */
    static bool getDefaultValue(const std::string& name, std::string& value);
     ...
     */
    static bool updateValue(const std::string& name, const std::string& value);
 ...
 */
#define FLAG(t, n, v, d) _FLAG(t, n, v, d, 0, 0, 0, 0)

/// See FLAG, but SHELL_FLAG%s are only available in osqueryi.
#define SHELL_FLAG(t, n, v, d) _FLAG(t, n, v, d, 1, 0, 0, 0)

/// See FLAG, but EXTENSION_FLAG%s are only available to extensions.
#define EXTENSION_FLAG(t, n, v, d) _FLAG(t, n, v, d, 0, 1, 0, 0)

/// See FLAG, but CLI_FLAG%s cannot be set within configuration "options".
#define CLI_FLAG(t, n, v, d) _FLAG(t, n, v, d, 0, 0, 1, 0)

/// See FLAG, but HIDDEN_FLAGS%s are not shown in --help.
#define HIDDEN_FLAG(t, n, v, d) _FLAG(t, n, v, d, 0, 0, 0, 1)

} // namespace ext
} // namespace gflags

#endif // EXTEND_FLAGS_H
